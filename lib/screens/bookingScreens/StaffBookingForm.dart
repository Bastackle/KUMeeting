...
class StaffBookingForm extends StatefulWidget {
  ...
  @override
  _StaffBookingFormState createState() => _StaffBookingFormState();
}

class _StaffBookingFormState extends State<StaffBookingForm> {
  ...
  Future<void> _getDepartments() async{
    List<String> organizationTypes = ['หน่วยงานมหาวิทยาลัย', 'อาจารย์'];
  ...
  Map<String, dynamic> toBody() {
    ...
    data['organizationId'] = _selectedDepartmentId;
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          backgroundColor: Theme.of(context).secondaryHeaderColor,
          elevation: 4, // ลดความสูงของ shadow
              ...
              child: Column(
                children: <Widget>[
                  ...
                  DropdownButtonFormField<String>(
                    items: _departments
                        .map((Map<String, String> department) => DropdownMenuItem<String>(
                              value: department['id'],
                              child: Text(
                                department['name']!,
                                style: TextStyle(
                    ...
                    validator: (value) =>
                        value == null ? 'กรุณาเลือกหน่วยงาน' : null,
                  ),
                  SizedBox(height: 16),
                  TextFormField(
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      ...
                      if (people == null || people > widget.room['capacity']) {
