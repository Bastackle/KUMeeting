...
class StdOrganiztionBookingForm extends StatefulWidget {
  ...
  _StdOrganiztionBookingFormState createState() =>
      _StdOrganiztionBookingFormState();
}

class _StdOrganiztionBookingFormState extends State<StdOrganiztionBookingForm> {
  ...
  Map<String, dynamic> toBody() {
    ...
    data['otherOrganization'] = _selectedDepartment;
            ...
            Form(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  SizedBox(height: 16),
                  Visibility(
                    visible: _selectedDepartment == "ชมรม",
                    child: Column(
                      children: [
                        TextFormField(
